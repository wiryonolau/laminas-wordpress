...
use LaminasWordpress\Wordpress;
use LaminasWordpress\WordpressHooksInterface;
...
class Application
{
    ...
    protected function initApplication()
    {
        ...
        if (file_exists($this->options["plugin_directory"]. '/config/application.config.php')) {
            $config = \Laminas\Stdlib\ArrayUtils::merge($config, include $this->options["plugin_directory"]. '/config/application.config.php');
        }
